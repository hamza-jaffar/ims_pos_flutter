...
class PdfExportHelper {
  ...
  static Future<void> exportSystemReport(
            ...
            children: [
              ...
              pw.TableRow(
                children: [
                  pw.Padding(
                    padding: const pw.EdgeInsets.all(8),
                    child: pw.Text('Total Revenue (Sales)'),
                  ),
                  pw.Padding(
                    padding: const pw.EdgeInsets.all(8),
              ...
              pw.TableRow(
                children: [
                  pw.Padding(
                    padding: const pw.EdgeInsets.all(8),
                    child: pw.Text('Total Spend (Purchases)'),
                  ),
                  pw.Padding(
                    padding: const pw.EdgeInsets.all(8),
                    child: pw.Text(totalSpend.toStringAsFixed(2)),
                  ),
                ],
              ),
              pw.TableRow(
              ...
              pw.TableRow(
                children: [
                  pw.Padding(
                    padding: const pw.EdgeInsets.all(8),
                    child: pw.Text('Total Returns (Sales + Purchases)'),
                  ),
                  pw.Padding(
                    padding: const pw.EdgeInsets.all(8),
                    child: pw.Text(totalReturns.toStringAsFixed(2)),
                  ),
                ],
              ),
            ],
    ...
    await _printDocument(pdf, 'system_dashboard_report.pdf');
  }
}
