...
class CreateRoomScreen extends StatefulWidget {
  ...
  const CreateRoomScreen({super.key, required this.onRouteSelected});
  ...
  Future<void> _handleSave() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Failed to save room: $error'),
            backgroundColor: AppColors.danger,
          ),
        );
      }
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Create a warehouse room to assign products to specific storage locations.',
