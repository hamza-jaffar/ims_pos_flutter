            ...
            children: [
              Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 4),
                  Text(
                    'View and download all system invoices',
                    style: TextStyle(
                      fontSize: 13,
                ...
                children: [
                  ListView.builder(
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      if (invoice.type.contains('Return')) {
                      ...
                      return Container(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            '${invoice.type} • ${DateFormat('yyyy-MM-dd HH:mm').format(invoice.purchaseDate)}',
                          ),
                          trailing: Row(
                    ...
                    Padding(
                      ...
                      child: Center(
                        child: TextButton.icon(
                          ...
                          label: Text(
                            'Load More (${_filtered.length - _displayLimit} remaining)',
                          ),
                        ),
                      ),
                    ),
...
class InvoiceDetailSheet extends StatelessWidget {
  final Purchase sale;
  const InvoiceDetailSheet({super.key, required this.sale});
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (sale.items.isEmpty)
                    ...
                    ...sale.items.map((item) {
                      final canReturn =
                          sale.type == 'Sale' && item.quantity > 0;
                      return Container(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    if (canReturn) ...[
                                      ...
                                      TextButton(
                                        onPressed: () =>
                                            _promptReturnItem(context, item),
