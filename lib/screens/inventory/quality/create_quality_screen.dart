...
class CreateQualityScreen extends StatefulWidget {
  final ValueChanged<String> onRouteSelected;

  const CreateQualityScreen({super.key, required this.onRouteSelected});

  @override
  State<CreateQualityScreen> createState() => _CreateQualityScreenState();
}

class _CreateQualityScreenState extends State<CreateQualityScreen> {
  ...
  Future<void> _handleSave() async {
    ...
    try {
      await QualityService.instance.create(quality);
      if (mounted) {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Failed to save quality: $error'),
            backgroundColor: AppColors.danger,
          ),
        );
      }
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Add a new quality grade for your products.',
