...
class CreateBrandScreen extends StatefulWidget {
  ...
  const CreateBrandScreen({super.key, required this.onRouteSelected});
...
class _CreateBrandScreenState extends State<CreateBrandScreen> {
  ...
  Future<void> _handleSave() async {
    ...
    try {
      await BrandService.instance.create(brand);
      if (mounted) {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Failed to save brand: $error'),
            backgroundColor: AppColors.danger,
          ),
        );
      }
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Add a new brand to organize your inventory products.',
